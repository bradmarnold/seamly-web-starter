  ...
  return (
    ...
    >
      ...
      {(effectiveMode==='lineBetween' && pickA!=null) ? (() => {
        const A = points.find(p=>p.id===pickA)!; const B = snapAngle45(A, snap ?? cursor) && (shiftDown ? snapAngle45(A, snap ?? cursor) : (snap ?? cursor));
